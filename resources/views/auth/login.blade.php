<x-layout>
    ...
    <x-card class="py-12 px-16">
        <form action="{{route('login')}}" method="POST">
            @csrf
            <div class="mb-8">
                <label for="email" class="font-medium mb-2 block text-sm text-slate-900">E-mail</label>
                <x-text-input name="email" />
            </div>

            <div class="mb-8">
                <label for="password" class="font-medium mb-2 block text-sm text-slate-900">Password</label>
